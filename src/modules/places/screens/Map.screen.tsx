...
interface MapInput extends NativeStackScreenProps<PlaceStackType, PlaceRoutes.Details> { } 

export const MapScreen: FunctionComponent<MapInput> = (props: MapInput) => {
    ...
    return (
        <FetchStateContainer
            empty={{ isEmpty: !place?.id, emptyBtnText: i18next.t('Map.empty') }}
            loading={!place}
        >
